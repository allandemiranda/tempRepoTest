...
/**
 * Imagine that the code bellow is facing some performance issues in production. You have the task to spot the biggest
 * bottleneck in this code and write a code to fix it. Unit tests are not required for this exercise.
 */
